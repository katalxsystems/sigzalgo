...
class CompositedgeWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        if not auth_data:
            ...
            api_key, api_secret = resolve_broker_api_key_market(auth_token, "compositedge")
            ...
            default_key, default_secret = resolve_broker_api_key_market(auth_token, "compositedge")
