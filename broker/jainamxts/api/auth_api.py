...
def authenticate_broker(request_token, account_id=None):
    try:
        ...
        BROKER_API_KEY = get_broker_api_key(account_id, broker="jainamxts")
        BROKER_API_SECRET = get_broker_api_secret(account_id, broker="jainamxts")
...
def get_feed_token(account_id=None):
    try:
        ...
        BROKER_API_KEY_MARKET = get_broker_api_key_market(account_id, broker="jainamxts")
        BROKER_API_SECRET_MARKET = get_broker_api_secret_market(account_id, broker="jainamxts")
