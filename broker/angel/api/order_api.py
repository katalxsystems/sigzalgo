...
from utils.config import require_broker_api_key
...
def get_api_response(endpoint, auth, method="GET", payload="", max_retries=2):
    AUTH_TOKEN = auth
    api_key, _ = require_broker_api_key(AUTH_TOKEN, "angel")
...
def place_order_api(data, auth):
    AUTH_TOKEN = auth
    BROKER_API_KEY, _ = require_broker_api_key(AUTH_TOKEN, "angel")
